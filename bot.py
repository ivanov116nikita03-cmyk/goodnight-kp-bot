...
def build_docs(data):
    ...
    try:
        ...
        dog_pairs = [
            ...
            # ── Старые значения шаблона (шапка и блок 7) ────────────────────
            # Название заказчика в шапке
            ...
            ('997750001',     kpp),
            ('044525823',     bik_zak),
            ('БАНК ГПБ (АО)', bank_zak or '—'),
            ('40702810100000003759', rs_zak),
            # к/с может быть склеен со старым значением
            ('3010181064525000009230101810200000000823', ks_zak),
